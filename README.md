...
| `grade` | registered tools | `mcp__sift__grade` runs a pack (issue, pr, hunks, commit, release, rules, locate, plan, ci, or a repo-defined one), `mcp__sift__judge` answers raw typed questions and `mcp__sift__rank` asks the same questions of many items | on |
...
grade(pack: "hunks", subject: "42")            # which hunk of PR 42 is wrong: unrelated, a workaround, or untested; a range works too
